...
public class GridImageAdapter extends
    ...
    /**
     * The listener of clicking "add" picture
     */
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        //Less than 8 pictures, continue to display the add icons
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    // It sometimes returns to 1, causing the data to be subscript across the border, getAdapterPosition()
            ...
            if (media.isCut() && !media.isCompressed()) {
                ...
                // Compressed, or cropped and compressed at the same time
            ...
            if (media.isCompressed()) {
                ...
                Log.i("compress address::", media.getCompressPath());
            }

            Log.i("Original address::", media.getPath());
            int pictureType = PictureMimeType.isPictureType(media.getPictureType());
            if (media.isCut()) {
                Log.i("cut address::", media.getCutPath());
            }
